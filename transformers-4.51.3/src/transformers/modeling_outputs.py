...
class BaseModelOutputWithPast(ModelOutput):
    ...
    hidden_states: Optional[Tuple[torch.FloatTensor, ...]] = None
    last_token_hidden_states: Optional[Tuple[torch.FloatTensor, ...]] = None
    last_token_norm_hidden_states: Optional[Tuple[torch.FloatTensor, ...]] = None
    last_token_norm_residual_states: Optional[Tuple[torch.FloatTensor, ...]] = None
    attentions: Optional[Tuple[torch.FloatTensor, ...]] = None
